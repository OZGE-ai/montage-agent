...
| v3 → v4 | "Take the music from the screen recording; between quotes — a whoosh, not a black insert" | Zoom transition + synthesised whoosh, client's music | `render.py`, `sfx.py` |
